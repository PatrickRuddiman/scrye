...
- The exact dropbox/witchcraft commit hash to pin against in `Cargo.toml` is intentionally not chosen in this doc — it gets set when the first task here begins coding and is bumped explicitly thereafter.
